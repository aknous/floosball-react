    ...
    content: (
      <>
        ...
        <p style={{ color: '#64748b', lineHeight: '1.6', fontSize: '13px' }}>
          Everything runs automatically — just watch, follow your favorite team, and compete.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p style={{ color: '#94a3b8', lineHeight: '1.6', marginBottom: '12px' }}>
          ...
          (QB, RB, WR, TE, K) each season. They earn Fantasy Points based on their real game stats.
          You can swap players between games using roster swaps.
        </p>
        <p style={{ color: '#94a3b8', lineHeight: '1.6', marginBottom: '12px' }}>
          <span style={{ color: '#eab308', fontWeight: '600' }}>Trading Cards</span> — Collect player cards
          from packs or the shop. Equip cards to your roster slots for bonus Fantasy Points.
          Higher edition cards (Holo, Gold, Diamond) give bigger bonuses.
        </p>
        <p style={{ color: '#94a3b8', lineHeight: '1.6', fontSize: '13px' }}>
          ...
          finishes, team achievements, and season payouts. Spend them on card packs and featured cards.
        </p>
      </>
    ),
  },
