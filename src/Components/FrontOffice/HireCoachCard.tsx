  ...
  return (
    <div style={{ flex: 1, minWidth: '240px' }}>
      ...
      <div style={{ fontSize: '13px', color: '#94a3b8', marginBottom: '8px' }}>
        Should the grievance succeed, nominate a preferred replacement. Whoever has the most votes is hired — but other teams are hiring from the same pool, so your top pick may sign elsewhere. Spread votes across backups so you're not stuck with the auto-pick.
      </div>
