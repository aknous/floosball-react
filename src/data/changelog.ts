    ...
    sections: [
      {
        label: 'New Features',
        items: [
          '[Simulation] No-huddle offense. A team in a hurry stays at the line, trading its deep playbook for tempo.',
          '[Simulation] Audibles. A quarterback reads the box and changes the call at the line. Reading it wrong costs him.',
          '[Simulation] Defenses disguise their look. What they show before the snap is not always what they run.',
          '[Prognostications] Pick from the front page, and from the win probability gauge on the game page.',
          '[Record Book] Team Records, built from every game played.',
          '[Standings] Clinched berths, division titles and the top seed are marked on the board.',
          '[Cards] Every card names the stat it is watching, on the card, in the breakdown, and on the player page.',
          '[Players] Punt return stats, and per game averages next to season totals.',
          '[Games] Timeouts remaining on the game page.',
          '[Front Page] The Floos Bowl champion leads league news.',
      ...
      },
      {
        label: 'Changes',
        items: [
          '[Shop] The card selection stays until you reroll it. Save for a card without it disappearing overnight.',
          '[Shop] The first reroll each day is free.',
          '[Schedule] Prognostications and the shop open for the next day right after the last game ends.',
          '[Facilities] Prices no longer swing on one user\'s biggest week.',
          '[Simulation] Fewer runaway sack games, without flattening pass rush quality.',
          '[Simulation] A sack no longer stops the clock.',
          '[Simulation] Teams run a two minute drill at the end of the second quarter whatever the score.',
          '[Simulation] A team in range takes the field goal on the last snap of a half, whatever the down.',
          '[Simulation] Chess clock rebuilt to mirror the game clock. Teams punt rather than run out their budget.',
          '[Front Office] A fired GM can be hired by another team instead of disappearing.',
          '[Front Office] GMs allow for their own scouting error in a deep free agent pool.',
          '[Front Office] A player can re-sign with the same team more than once. One team careers are possible again.',
          '[Cards] Streak bonuses pay only when the streak is continued, and settle at week end.',
          '[Cards] Diversified pays less per output type.',
          '[Cards] Spotlight Moment is a wide receiver card, and reads only its own player.',
          '[Economy] Very large fantasy weeks pay less. Typical weeks are unchanged.',
        ],
      },
      {
        label: 'Fixes',
        items: [
          ...
          '[Playoffs] The bracket challenge showed byes in a field that has none, then reshaped after round one.',
