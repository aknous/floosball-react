    ...
    sections: [
      {
        ...
        items: [
          ...
          '[Prognostications] Pick games from the front page and the game page.',
          '[Record Book] Team records.',
          '[Standings] Clinched berths, division titles and the top seed are marked.',
          '[Cards] Every card names the stat it scores on.',
      ...
      },
      {
        ...
        items: [
          ...
          '[Schedule] Prognostications and the shop open for the next day right after the last game.',
          '[Facilities] One user\'s big week no longer raises facility prices for every team.',
          ...
          '[Simulation] Teams take the field goal on the last snap of a half.',
          '[Simulation] Chess clock games play more like a normal game clock.',
          '[Front Office] A fired GM can be hired by another team.',
          '[Front Office] GMs make fewer bad cuts chasing free agents.',
          '[Front Office] A player can re-sign with the same team more than once.',
          '[Cards] Streak bonuses pay only when the streak continues.',
          '[Cards] Diversified pays less per output type.',
          '[Cards] Spotlight Moment is a wide receiver card.',
